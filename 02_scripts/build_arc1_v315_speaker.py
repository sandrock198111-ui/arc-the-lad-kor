"""Build v315: keep the speaker name on its own line, real window width.
...
OUT = ROOT / "03_output"
STEM = "arc1_v315_speaker_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v315_speaker"
...
def main():
    ...
    rep = [
        "v315 TEST ONLY - speaker line kept, width 14",
        "output=%s" % out.name,
        "sha256=%s" % st,
