...
STEM = "arc1_v256_all_inplace_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v256_all_inplace"
...
def main() -> None:
    ...
    for r in rows:
        ...
        while e < len(buf) and buf[e]:
            e += 1
        # E2 xx is a control command, not a pointer to text held elsewhere --
        # the glyphs follow it in place.  Reading v253 back showed exactly that.
        # Treating it as a slot reference is what wrote 1366 lines into the
        # wrong place and hung the game.
        start, cap = off, e - off
    ...
    report = [
        "v256 TEST ONLY - every line re-encoded in place, control codes kept",
