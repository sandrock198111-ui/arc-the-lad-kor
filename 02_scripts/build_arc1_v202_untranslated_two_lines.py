...
BASE = ROOT / "03_output/arc1_v201_palencia_spelling.zip"
BASE_SHA256 = "8282C5FA907EE03E1B96C53B25213BE3548D5BF839A7147E35DE64E5AD730EDF"
OUT = ROOT / "03_output/arc1_v202_untranslated_two_lines.zip"
...
JOBS = (
    ("4/S4011.DAT", 0x485A2,
     "4b 73 29 36 98 29 1f 37 e4 1f e6 01 6e 20 cb 96 2a dd 15 35 37",
     ("잠깐.", "뭔가 이상해.")),
...
def main() -> None:
    ...
    for member, offset, japanese, korean in JOBS:
        ...
        if bytes(stock[member][offset:offset + len(want)]) != want:
            raise SystemExit(f"{member} 0x{offset:X} 가 원본 디스크와 다르다")
