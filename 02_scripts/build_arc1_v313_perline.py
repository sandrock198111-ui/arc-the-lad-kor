"""Build v313: 12px johab, one E2 per original line.
...
OUT = ROOT / "03_output"
STEM = "arc1_v313_perline_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v313_perline"
...
def main():
    ...
    rep = [
        "v313 TEST ONLY - per-line placement",
        "output=%s" % out.name,
        "sha256=%s" % st,
