...
OUTPUT = ROOT / "03_output/story_intro_halfwidth_space_v09_cumulative_patch_only.zip"
REPORT = ROOT / "01_work/analysis/story_intro_halfwidth_space_v09_report.txt"
...
def main() -> None:
    ...
    patched = (
        ...
        0x94C20006,  # lhu   v0,06(a2) (delay)
        0x34030006,  # ori   v1,zero,6 (space width)
        0x00431021,  # normal: addu v0,v0,v1
        0xA4C20006,  # sh    v0,06(a2)
        0x94C4000A,  # lhu   a0,0A(a2)
        0x24840001,  # addiu a0,a0,1
        0xA4C4000A,  # sh    a0,0A(a2)
