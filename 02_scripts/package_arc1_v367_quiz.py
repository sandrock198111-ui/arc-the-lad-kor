"""Package V367 into fresh original-disc staging; preserve prior images."""
import json,subprocess,sys
import package_test_iso as p
import build_arc1_v367_quiz as b
ROOT=b.ROOT;stem='V367_QUIZ_TEST'
p.WORK=ROOT/'01_work/package_v367_quiz';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
