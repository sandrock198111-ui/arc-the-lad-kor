"""Package approved V371 changes into fresh original-disc staging."""
...
ROOT=b.ROOT;stem='V371_SPEAKER_FIXES_TEST'
p.WORK=ROOT/'01_work/package_v371_speaker_fixes';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
...
assert len(verify(b.OUT.read_bytes()))==4
