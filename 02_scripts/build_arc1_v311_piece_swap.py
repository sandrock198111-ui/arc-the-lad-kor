"""Build v311: 12px johab, per-jamo piece source.
...
OUT = ROOT / "03_output"
STEM = "arc1_v311_piece_swap_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v311_piece_swap"
...
CHO_PIECE_FONT = {17: "Iyagi_8x4x4.ttf"}
...
def main():
    ...
    rep = [
        "v311 TEST ONLY - 12px johab, PIEUP-choseong taken from Iyagi",
        "output=%s" % out.name,
        "sha256=%s" % st,
