"""Read-only sector envelope and EDC/ECC verification for V368 Sans."""
from pathlib import Path
import json,hashlib
from verify_arc1_v362_disc_delta import timestamp_bytes,check_form1
from verify_iso_layout import read_iso
ROOT=Path(__file__).resolve().parents[1];AN=ROOT/'01_work/analysis/v368_sans_font'
old=ROOT/'03_output/V368_LINEBREAKS_TEST.bin';new=ROOT/'03_output/V368_SANS_FONT_TEST.bin'
