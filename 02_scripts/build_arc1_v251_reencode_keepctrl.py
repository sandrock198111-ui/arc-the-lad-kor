...
STEM = "arc1_v251_reencode_keepctrl_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v251_reencode"
...
def main() -> None:
    ...
    report = [
        "v251 TEST ONLY - re-encoded from source, control codes preserved",
