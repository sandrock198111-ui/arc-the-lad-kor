...
BASE = ROOT / "03_output/arc1_v199_wording_fixes_safe.zip"
BASE_SHA256 = "6FAE81A2D1FBE9FB1D3740C0EB8C23FDEC70F4C6462F43831C3DDD577B9A571D"
OUT = ROOT / "03_output/arc1_v200_jail_scene_wording.zip"
...
JOBS = (
    ("4/S4022.DAT", 0x47A68, "약속만은 지켜 줄 거지!", "약속은 지켜라!"),
    ("4/S4022.DAT", 0x47AFA, "목숨과 맞바꿔서 나는 이렇게 하고 있는 거야.", "목숨을 맞바꿔 끌려온거다."),
    ("4/S4022.DAT", 0x47BF6, "그런데 정말 잘 타는군.", "그건 그렇고, 잘도 타더군."),
)
...
def main() -> None:
    ...
    print("v200  감옥 장면 문구 세 곳 (구조 변경 없음)")
