...
ROOT=Path(__file__).resolve().parents[1];AN=ROOT/'01_work/analysis/v368_linebreaks'
old=ROOT/'03_output/V367_QUIZ_TEST.bin';new=ROOT/'03_output/V368_LINEBREAKS_TEST.bin'
