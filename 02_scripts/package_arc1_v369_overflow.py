...
import build_arc1_v369_overflow as b
ROOT=b.ROOT;stem='V369_OVERFLOW_TEST'
p.WORK=ROOT/'01_work/package_v369_overflow';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
