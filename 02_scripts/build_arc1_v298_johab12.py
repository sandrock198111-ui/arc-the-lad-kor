"""Build v298: 12px johab from the original disc.
...
FONT_NAME = "Dkby_8x4x4.ttf"
ORIG_CSV = ROOT / "05_docs/script_original_full.csv"
TRANS_CSV = ROOT / "05_docs/script_translated_full.csv"
OUT = ROOT / "03_output"
STEM = "arc1_v298_johab12_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v298_johab12"
...
def main():
    ...
    rep = [
        "v298 TEST ONLY - 12px johab from the original disc",
        "output=%s" % out.name,
        "sha256=%s" % st,
