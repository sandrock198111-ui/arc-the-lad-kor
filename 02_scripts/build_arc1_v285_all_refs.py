...
OUT = ROOT / "03_output"
STEM = "arc1_v285_all_refs_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v285_all_refs"
...
def main() -> None:
    ...
    ptr = ROOT / "01_work/analysis/exe_ptr_strings.pkl"
    n_ui = 0
    if ptr.exists():
    ...
    rep = [
        "v285 TEST ONLY - 16px, every reference found by pointer tracing",
