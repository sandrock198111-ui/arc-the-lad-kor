...
STEM = "arc1_v265_decoded_full_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v265_decoded_full"
...
def main() -> None:
    ...
    rep = [
        "v265 TEST ONLY - all cached glyphs resident; unreachable cells reclaimed",
