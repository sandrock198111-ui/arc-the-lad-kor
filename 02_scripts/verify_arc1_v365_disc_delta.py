"""Read-only sector envelope and EDC/ECC verification for V365."""
...
old=ROOT/'03_output/V364_CURSOR_SPEAKER_TEST.bin';new=ROOT/'03_output/V365_COMPACT_CHOICE_TEST.bin'
