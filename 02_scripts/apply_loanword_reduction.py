...
PROPOSALS = [
    ...
    ("볼륨을", "소리를"), ("스캔은", "조사는"), ("컨디션이", "몸 상태가"),
    # onomatopoeia and interjections
    ("캬캬캬캬캬", "크크크크크"), ("우히햐햐", "우히히히"), ("눈이 핑핑 도는데", "눈이 어지러운데"),
    ...
    ("갖고", "가지고"), ("층이 깊은", "층이 많은"),
    ("유적은 깊은 곳에 더 아래층이", "유적은 더 아래층이"),
    ("깊은 층일수록", "아래층일수록"), ("지하 깊은 곳에", "지하 아래쪽에"),
    ("왠지", "어딘가"), ("현재", "지금"), ("몇 번이고", "여러 번이고"), ("몇 번인가", "여러 번인가"),
    ("몇 가지", "여러 가지"), ("몇", "얼마"),
    ("모릅니다", "모르겠습니다"), ("밀마나로 보낸", "밀마나로 보내 둔"), ("보낸", "보내온"),
    ("완전히", "아주"), ("어쩔", "어찌할"), ("실컷", "마음껏"),
    ("어쩜", "어찌"), ("일찍이", "예전에"), ("그만둬", "그만두"),
    ("슬픈", "서러운"), ("똑똑히", "분명히"), ("그럴듯한", "말이 되는"), ("꽤", "제법"),
    ("뭉개", "으깨"), ("추한", "더러운"), ("굳센", "든든한"),
    ...
    ("두둑이 상을", "상을 많이"), ("버팀목이", "받침이"), ("흉악한", "사악한"),
    ("더욱이", "게다가"), ("갇혀", "붙잡혀"), ("얌전히", "조용히"),
    ("느낌이", "기분이"), ("짐작하신", "생각하신"),
    ("힘냅시다", "힘내십시오"), ("햇빛도", "해도"), ("잣는", "짜는"),
