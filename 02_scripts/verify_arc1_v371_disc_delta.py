"""Final-disc sector envelope and EDC/ECC verification against protected V370."""
from pathlib import Path
import json,hashlib
from verify_arc1_v362_disc_delta import timestamp_bytes,check_form1
from verify_iso_layout import read_iso
ROOT=Path(__file__).resolve().parents[1];AN=ROOT/'01_work/analysis/v371_speaker_fixes'
old=ROOT/'03_output/V370_EVENT_RESTORE_TEST.bin';new=ROOT/'03_output/V371_SPEAKER_FIXES_TEST.bin'
assert hashlib.sha256(old.read_bytes()).hexdigest().upper()=='5E7FF5D2D1FBFD61354F7C2A1E4297506C88EED4673791E09CCF448CD3F93007'
