...
OUT = ROOT / "03_output"
STEM = "arc1_v290_safe_slots_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v290_safe_slots"
...
def main() -> None:
    ...
    rep = [
        "v290 TEST ONLY - 16px, Korean confined to the verified-safe slot range",
