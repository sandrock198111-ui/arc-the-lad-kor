"""Build v314: per-line placement plus a second E2 slot bank.
...
OUT = ROOT / "03_output"
STEM = "arc1_v314_bankb_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v314_bankb"
...
def main():
    ...
    rep = [
        "v314 TEST ONLY - per-line placement + bank B",
        "output=%s" % out.name,
        "sha256=%s" % st,
