...
ROOT=Path(__file__).resolve().parents[1];AN=ROOT/'01_work/analysis/v370_event_abort'
old=ROOT/'03_output/V369_OVERFLOW_TEST.bin';new=ROOT/'03_output/V370_EVENT_RESTORE_TEST.bin'
