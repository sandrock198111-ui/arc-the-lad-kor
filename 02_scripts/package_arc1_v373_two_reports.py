"""Fresh-original V373 packaging, comparing against V371 (not V372)."""
import json,subprocess,sys
import package_test_iso as p
import build_arc1_v373_two_reports as b
from verify_arc1_v362_disc_delta import timestamp_bytes,check_form1
from verify_iso_layout import read_iso

def main():
    stem='V373_TWO_REPORTS_TEST';root=b.ROOT
    p.WORK=root/'01_work/package_v373_two_reports';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
