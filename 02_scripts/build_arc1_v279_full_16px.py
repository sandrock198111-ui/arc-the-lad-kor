...
OUT = ROOT / "03_output"
STEM = "arc1_v279_full_16px_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v279_full_16px"
...
def main() -> None:
    ...
    rep = [
        "v279 TEST ONLY - full translated script at 16px, from the original disc",
