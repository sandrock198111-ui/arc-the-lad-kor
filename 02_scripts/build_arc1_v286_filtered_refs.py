...
OUT = ROOT / "03_output"
STEM = "arc1_v286_filtered_refs_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v286_filtered_refs"
...
def main() -> None:
    ...
    rep = [
        "v286 TEST ONLY - 16px, references filtered so no code is overwritten",
