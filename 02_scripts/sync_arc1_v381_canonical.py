"""Only the three approved semantic Korean-cell corrections; pause controls stay in build manifests."""
import csv,io,json
import build_arc1_v381_scene_pauses as b
PIN='09C1574F6A40526FA7F7D388E1835425C1B748BBB774166640903A5FC7B7CD87'
...
def main():
    ...
    backup=b.ROOT/'99_backup/v381_script_translated_full.csv'
    ...
    changes=[];targets={**b.previous.TEXT,644:''.join(b.previous.PAUSES[644])}
