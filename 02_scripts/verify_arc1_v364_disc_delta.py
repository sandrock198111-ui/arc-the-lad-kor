"""Read-only sector envelope and EDC/ECC verification for V364."""
...
old=ROOT/'03_output/V363_DIALOGUE_TRIAL_TEST.bin';new=ROOT/'03_output/V364_CURSOR_SPEAKER_TEST.bin'
