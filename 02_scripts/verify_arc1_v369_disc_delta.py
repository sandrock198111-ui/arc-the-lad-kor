...
ROOT=Path(__file__).resolve().parents[1];AN=ROOT/'01_work/analysis/v369_overflow'
old=ROOT/'03_output/V368_SANS_FONT_TEST.bin';new=ROOT/'03_output/V369_OVERFLOW_TEST.bin'
