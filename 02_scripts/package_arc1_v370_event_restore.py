"""Package V369 into fresh original-disc staging; preserve prior images."""
import json,subprocess,sys
import package_test_iso as p
import build_arc1_v370_event_restore as b
ROOT=b.ROOT;stem='V370_EVENT_RESTORE_TEST'
p.WORK=ROOT/'01_work/package_v370_event_restore';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
