...
def main():
    stem='V374_CARD_CHOICE_TEST';root=b.ROOT
    p.WORK=root/'01_work/package_v374_card_choice';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
    ...
    old=root/'03_output/V373_TWO_REPORTS_TEST.bin'
    assert p.digest(old)=='0DB641C005B2218F27B9BBAFEAA7FE215BDAFA8415F45E689404B9BD3C657A89'
