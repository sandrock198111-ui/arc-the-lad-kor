"""Build v310: 12px johab, beol rule measured against the font itself.
...
OUT = ROOT / "03_output"
STEM = "arc1_v310_beol_fix_TEST_ONLY"
ANALYSIS = ROOT / "01_work/analysis/arc1_v310_beol_fix"
...
def main():
    ...
    rep = [
        "v310 TEST ONLY - 12px johab, measured beol rule",
        "output=%s" % out.name,
        "sha256=%s" % st,
