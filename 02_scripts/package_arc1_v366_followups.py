"""Package V366 into fresh original-disc staging; preserve prior images."""
import json,subprocess,sys
import package_test_iso as p
import build_arc1_v366_followups as b
ROOT=b.ROOT;stem='V366_FOLLOWUPS_TEST'
p.WORK=ROOT/'01_work/package_v366_followups';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
