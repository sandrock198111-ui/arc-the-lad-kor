"""Package V368 into fresh original-disc staging; preserve prior images."""
import json,subprocess,sys
import package_test_iso as p
import build_arc1_v368_sans_font as b
ROOT=b.ROOT;stem='V368_SANS_FONT_TEST'
p.WORK=ROOT/'01_work/package_v368_sans_font';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
