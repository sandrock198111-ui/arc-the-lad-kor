"""Package V364 into fresh original-disc staging; preserve prior images."""
import json,subprocess,sys
import package_test_iso as p
import build_arc1_v364_cursor_speaker as b
ROOT=b.ROOT;stem='V364_CURSOR_SPEAKER_TEST'
p.WORK=ROOT/'01_work/package_v364_cursor_speaker';p.FILES=p.WORK/'files';p.STATE=p.WORK/'applied.json'
